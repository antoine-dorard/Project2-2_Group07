...
public class ConfigUI {
    ...
    // Fonts
    private final String customFont = "Monospaced";
    public final Font fontList = new Font(customFont, Font.BOLD, 14);
    public final Font fontText = new Font(customFont, Font.BOLD, 18);
