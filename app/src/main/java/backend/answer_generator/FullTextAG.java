...
public class FullTextAG implements AnswerGenerator{
    private SkillLoader skillLoader;

    private HashMap<String, String> placeHolders;


    public FullTextAG(SkillLoader skillLoader) {
    ...
    public String generateAnswer(String input) {
        return generateOnFullText(input);
    }


    private String generateOnFullText(String input){
