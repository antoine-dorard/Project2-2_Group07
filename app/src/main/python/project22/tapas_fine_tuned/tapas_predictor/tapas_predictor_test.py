...
table =  pd.read_csv(directory + "\TAPAS\student_schedule_week.csv").astype(str)

predictor = TapasPredictor(model_path = directory + '\TAPAS\schedule-tapas-small-finetuned-sqa.pth')

answers = predictor.generate_answers(queries, table)
